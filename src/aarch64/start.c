...
uint8_t hrtmon_required = 0;
uint8_t ariv_required = 0;
void *arromdata = NULL;
...
void parse_cmdline(const char *cmdline)
{
    ...
    debounce_nmi = !!find_token(cmdline, "debounce_nmi");
    joystickl7 = !!find_token(cmdline, "joystick_l7");
